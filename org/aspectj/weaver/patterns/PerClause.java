...
public abstract class PerClause extends Pointcut {
	...
	protected String aspectsStorageClassName;
	protected StaticPerscope staticPerscope;
	
	public StaticPerscope getStaticPerscope() {
		return staticPerscope;
	}
	public void setStaticPerscope(
			StaticPerscope staticPerscope) {
		this.staticPerscope = staticPerscope;
	}
	public String getAspectsStorageClassName() {
		return aspectsStorageClassName;
	}
	protected PerClause() {

	}
	protected PerClause(String aspectsStorageClassName) {
		this.aspectsStorageClassName = aspectsStorageClassName;
	}
