...
perscope (org.aspectj.ajdt.internal.compiler.ast.perscope.storage.PertargetAspectsStorage,Any.Initialization()){
  ...
  public boolean contains(Object /*[*/target/*]*//**+target+**/) {
    return super.containsValue(/*[*/target/*]*//**+target+**/) ||
      Percflow.aspectOf(null).containsValue(/*[*/target/*]*//**+target+**/);
  }
