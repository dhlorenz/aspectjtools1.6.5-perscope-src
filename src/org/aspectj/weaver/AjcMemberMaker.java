...
import org.aspectj.ajdt.internal.compiler.ast.perscope.storage.AspectStorageProvider;
...
public class AjcMemberMaker {
	...
	public static final UnresolvedType THREAD_LOACAL_ASPECTS_STORAGE = UnresolvedType
	.forSignature("Lorg/aspectj/ajdt/internal/compiler/ast/ThreadLocalAspectsStorage;");


	public static final UnresolvedType PER_TARGET_ASPECTS_STORAGE = UnresolvedType
	.forSignature("Lorg/aspectj/ajdt/internal/compiler/ast/PertargetAspectsStorage;");

	public static final UnresolvedType JAVA_LANG_CLASS = UnresolvedType
	.forSignature("Ljava/lang/Class;");

	
	
	public final static  UnresolvedType ASPECTS_STORAGE = UnresolvedType
	.forSignature("Lorg/aspectj/ajdt/internal/compiler/ast/perscope/storage/AspectsStorage;");

	
	public static final UnresolvedType ASPECT_STORAGE_PROVIDER_TYPE = UnresolvedType
	.forSignature("Lorg/aspectj/ajdt/internal/compiler/ast/perscope/storage/AspectStorageProvider;");

	public static final UnresolvedType MY_ASPECT_TYPE = UnresolvedType
	.forSignature("Lmy/MyPertargetAspect;");

public static ResolvedMember providerBindMethod(UnresolvedType declaringType) {
		
		System.out.println(declaringType.getSignature());
		return new ResolvedMemberImpl(Member.METHOD, ASPECT_STORAGE_PROVIDER_TYPE, Modifier.PUBLIC | Modifier.STATIC, "bindAspectToObject",
				"(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V");
	}

public static ResolvedMember providerAspectOfMethod(UnresolvedType declaringType) {
	
	System.out.println(declaringType.getSignature());
	return new ResolvedMemberImpl(Member.METHOD, ASPECT_STORAGE_PROVIDER_TYPE, Modifier.PUBLIC | Modifier.STATIC, "aspectOf",
			"(Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Object;)Ljava/lang/Object;");
}

public static ResolvedMember providerHasAspectMethod(UnresolvedType declaringType) {
	
	System.out.println(declaringType.getSignature());
	return new ResolvedMemberImpl(Member.METHOD, ASPECT_STORAGE_PROVIDER_TYPE, Modifier.PUBLIC | Modifier.STATIC, "hasAspect",
			"(Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Object;)Z");
}

	public static ResolvedMember getInstanceMethod(UnresolvedType declaringType) {
		
		System.out.println(declaringType.getSignature());
		return new ResolvedMemberImpl(Member.METHOD, ASPECT_STORAGE_PROVIDER_TYPE, Modifier.PUBLIC | Modifier.STATIC, "getInstance",
				"()Lorg/aspectj/ajdt/internal/compiler/ast/perscope/storage/AspectStorageProvider;");
	}

public static ResolvedMember printLineMethod(UnresolvedType declaringType) {
		
		System.out.println(declaringType.getSignature());
		return new ResolvedMemberImpl(Member.METHOD, MY_ASPECT_TYPE, Modifier.PUBLIC | Modifier.STATIC, "printLine",
				"(Ljava/lang/String;)V");
	}

	public static ResolvedMember classForName(UnresolvedType declaringType) {
		System.out.println(declaringType.getSignature());
		return new ResolvedMemberImpl(Member.METHOD, JAVA_LANG_CLASS, Modifier.PUBLIC | Modifier.STATIC, "forName",
				"(Ljava/lang/String;)Ljava/lang/Class;");
	}

	public static ResolvedMember aspectClassField(UnresolvedType declaringType) {
		System.out.println(declaringType.getSignature());
		return new ResolvedMemberImpl(Member.FIELD, declaringType, PUBLIC_STATIC_FINAL, "class",
				declaringType.getSignature());
	}

	
	/*public static ResolvedMember aspectsStorageConstructor() {		
		return new ResolvedMemberImpl(Member.METHOD, PER_TARGET_ASPECTS_STORAGE, Modifier.PUBLIC, "<init>",
				"()V");
	}
*/
	
	public static ResolvedMember aspectsStorageF(UnresolvedType aspectsStorageType) {
		return new ResolvedMemberImpl(Member.METHOD, aspectsStorageType, Modifier.PUBLIC | Modifier.ABSTRACT,
				"f", "()V");
	}

	public static ResolvedMember aspectsStorageBindAspect(UnresolvedType aspectsStorageType) {
		return new ResolvedMemberImpl(Member.METHOD, aspectsStorageType, Modifier.PUBLIC | Modifier.ABSTRACT,
				"bindAspectToObject", "(Ljava/lang/Object;Ljava/lang/Object;)V;");
	}

	public static ResolvedMember aspectsStorageAspectOf(UnresolvedType aspectsStorageType) {
		return new ResolvedMemberImpl(Member.METHOD, aspectsStorageType, Modifier.PUBLIC,
				"aspectOf", "(Ljava/lang/Class;Ljava/lang/Object;)Ljava/lang/Object;");
	}
	public static ResolvedMember aspectsStorageHasAspect(UnresolvedType aspectsStorageType) {
		return new ResolvedMemberImpl(Member.METHOD, aspectsStorageType, Modifier.PUBLIC,
				"hasAspect", "(Ljava/lang/Class;Ljava/lang/Object;)Z");
	}

	
	//PertargetAspectsStorage
	
	

	public static ResolvedMember threadLocalGetAspect() {
		return new ResolvedMemberImpl(Member.METHOD, THREAD_LOACAL_ASPECTS_STORAGE, PUBLIC_STATIC, "getAspect", "(Ljava/lang/Object;)"
				+ THREAD_LOACAL_ASPECTS_STORAGE.getSignature());
	}

	public static ResolvedMember threadLocalSetAspect() {
		return new ResolvedMemberImpl(Member.METHOD, THREAD_LOACAL_ASPECTS_STORAGE, PUBLIC_STATIC, "setAspect", "()V"
				+ THREAD_LOACAL_ASPECTS_STORAGE.getSignature());
	}


	public static ResolvedMember perObjectInterfaceSet111111(UnresolvedType aspectType) {
	...
	public static ResolvedMember threadLocalSetAspect(UnresolvedType aspectType) {
		return new ResolvedMemberImpl(Member.METHOD, THREAD_LOACAL_ASPECTS_STORAGE, Modifier.PUBLIC | Modifier.STATIC,
				"setAspect", "(Ljava/lang/Object;)V");
	}

	
	public static UnresolvedType threadLocalType(UnresolvedType aspectType) {
		return UnresolvedType.forName(aspectType.getName());
	}

	
	public static final UnresolvedType MY_CLASS = UnresolvedType
	.forSignature("Lorg/aspectj/ajdt/internal/compiler/ast/MyClass;");

	public static Member myClassMember() {
		
		return new ResolvedMemberImpl(Member.METHOD, MY_CLASS, Modifier.PUBLIC, "<init>",
				"()V");
	}
	...
	public static ResolvedMember perObjectBind(UnresolvedType declaringType) {
		return new ResolvedMemberImpl(Member.METHOD, declaringType, PUBLIC_STATIC, "perObjectBind",//NameMangler.PEROBJECT_BIND_METHOD,
				"(Ljava/lang/Object;)V");
	}
